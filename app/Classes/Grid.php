...
final class Grid
{
    ...
    /**
     * Get coordinate statuses
     *
     * Fetch list of all stored coordinate statuses from this grid object.
     *
     * @return array $coordinateStatuses
     */
    ...
    /**
     * Set grid coordinate statuses
     *
     * Update a grid coordinate's status (e.g. once it is fired upon).
     *
     * @param string $coordinate A valid coordinate value pair, as generated by self::generateCoordinateValuePair().
     * @return string $status Should be derived from one of self::COORDINATE_STATUS_xxx constants.
     * @return void
     */
    ...
    /**
     * Generate coordinate value pair
     *
